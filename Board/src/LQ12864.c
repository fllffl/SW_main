...
//--------------------定义IO端口-----------------//
#define LCD_DC(x)       gpio_set(PTC19,x)
#define LCD_RST(x)      gpio_set(PTC18,x)//PTC18_OUT  //C18
#define LCD_SDA(x)  gpio_set(PTC17,x)  //C17
#define LCD_SCL(x)  gpio_set(PTC16,x)  //C16 
 ...
 */
void LCD_P6x8Num(unsigned char x, unsigned char y, uint32 num)
{
  uint32 res = num;
  uint8 t = 0;
  char sitetempx;
  ...
  {
    sitetempx = x + (8 * (t--) - 8);
    LCD_P6x8Char(sitetempx, y, (num % 10) + '0');
    num /= 10 ;
  }
}
//==============================================================
...
void LCD_P8x16Num(unsigned char x, unsigned char y, uint32 num)
{
  uint32 res = num;
  uint8 t = 0;
  char sitetempx;
  ...
  {
    sitetempx = x + (8 * (t--) - 8);
    LCD_P8x16Char(sitetempx, y, (num % 10) + '0');
    num /= 10 ;
  }
}
//==============================================================
